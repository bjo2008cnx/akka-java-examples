...
import org.royrusso.actor.Handler2;
 ...
 */
public class SystemMultiSuscrible {

    public static final Logger log = LoggerFactory.getLogger(SystemMultiSuscrible.class);
    ...
    public static void main(String... args) throws Exception {
        ...
        final ActorRef handler2 = actorSystem.actorOf(Props.create(Handler2.class));

        actorSystem.eventStream().subscribe(handler, Event.class);
        actorSystem.eventStream().subscribe(handler2, Event.class);
